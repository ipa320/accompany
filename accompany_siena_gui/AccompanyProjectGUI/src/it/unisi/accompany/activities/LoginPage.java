...
public class LoginPage extends Activity{
	...
	public void onResume()
	{
		...
		{
			Log.e("AccompanyGUI-LoginPage","problem to reopen the usb device!");
		}
   ...
   /*public void switchToUser()
			...
			public void onClick(View arg0) {
	       	...
	       	yes.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						popupWindow.dismiss();
						if (pd!=null) pd.dismiss();
						pd= ProgressDialog.show(LoginPage.this, LoginPage.this.getResources().getString(R.string.gui_title),
    ...
    {
    	if (pd!=null) pd.dismiss();
		pd= ProgressDialog.show(this, this.getResources().getString(R.string.gui_title), "The App is still closing, please wait before restart it.");
		...
		new Thread() {
			...
			public void run()
			{
				final int max_time=1000;  //1 secondo di attesa prima di chiudere!
				waited=0;
				try{
					while (waited < max_time)
					{
