...
public class Option extends Button implements View.OnTouchListener{
	...
	public void disappear()
	{
		...
		this.setWidth(1);
		this.setHeight(1);
		myLayout.invalidate(); //prova invalidate rect*/
		AnimatorSet reduction= new AnimatorSet();
		...
		ObjectAnimator growW=ObjectAnimator.ofInt(this, "width", REDUCEDWIDTH,3);
		ObjectAnimator growH=ObjectAnimator.ofInt(this, "height",REDUCEDWIDTH,3);
