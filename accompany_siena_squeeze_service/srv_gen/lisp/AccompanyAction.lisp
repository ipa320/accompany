...
(cl:in-package accompany_siena_squeeze_service-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AccompanyAction-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccompanyAction-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name accompany_siena_squeeze_service-srv:<AccompanyAction-request> is deprecated: use accompany_siena_squeeze_service-srv:AccompanyAction-request instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <AccompanyAction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader accompany_siena_squeeze_service-srv:action-val is deprecated.  Use accompany_siena_squeeze_service-srv:action instead.")
  (action m))

(cl:ensure-generic-function 'uid-val :lambda-list '(m))
(cl:defmethod uid-val ((m <AccompanyAction-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader accompany_siena_squeeze_service-srv:uid-val is deprecated.  Use accompany_siena_squeeze_service-srv:uid instead.")
  (uid m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AccompanyAction-request>)))
  ...
  "accompany_siena_squeeze_service/AccompanyActionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AccompanyAction-request)))
  "Returns string type for a service object of type 'AccompanyAction-request"
  "accompany_siena_squeeze_service/AccompanyActionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <AccompanyAction-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccompanyAction-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name accompany_siena_squeeze_service-srv:<AccompanyAction-response> is deprecated: use accompany_siena_squeeze_service-srv:AccompanyAction-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <AccompanyAction-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader accompany_siena_squeeze_service-srv:result-val is deprecated.  Use accompany_siena_squeeze_service-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AccompanyAction-response>)))
  ...
  "accompany_siena_squeeze_service/AccompanyActionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AccompanyAction-response)))
  "Returns string type for a service object of type 'AccompanyAction-response"
  "accompany_siena_squeeze_service/AccompanyActionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AccompanyAction)))
  ...
  "accompany_siena_squeeze_service/AccompanyAction")