...
int main(int argc, char **argv) {
  ...
  po::options_description optionsDescription("Select prior locations where people can walk\nAllowed options\n\n"
                                             "exmaple:\n  rosrun accompany_static_camera_localisation create_prior -l `rospack find accompany_uva`/res/testRobotHouse/cameras/list_of_images_small.txt -p `rospack find accompany_uva`/res/testRobotHouse/cameras/params.xml\n\nAllowed options");
