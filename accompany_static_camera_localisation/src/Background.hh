...
class Background: public XmlPackable
{
  ...
  public:
    ...
    void segment(const vnl_vector<FLOAT> &img, vnl_vector<FLOAT> &bg,
...
void getBackground(const char *filename, std::vector<Background> &bg,
    unsigned C = 3, unsigned smooth = 0);
