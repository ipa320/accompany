...
if __name__=='__main__':
	rospy.init_node('walkTogetherToSofaClient')
	try:
		client = actionlib.SimpleActionClient('/walkTogetherToSofaServer', accompany_user_tests_year2.msg.EmptyAction)
		rospy.loginfo("Waiting for the walkTogetherToSofaServer server to start...")
		client.wait_for_server()
		rospy.loginfo("walkTogetherToSofaServer action server started, sending goal...")
