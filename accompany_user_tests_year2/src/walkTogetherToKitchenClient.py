...
if __name__=='__main__':
	rospy.init_node('walkTogetherToKitchenClient')
	try:
		client = actionlib.SimpleActionClient('/walkTogetherToKitchenServer', accompany_user_tests_year2.msg.EmptyAction)
		rospy.loginfo("Waiting for the walkTogetherToKitchenServer server to start...")
		client.wait_for_server()
		rospy.loginfo("walkTogetherToKitchenServer action server started, sending goal...")
