"""autogenerated by genpy from accompany_user_tests_year2/UnloadTrayActionResult.msg. Do not edit."""
import sys
...
class UnloadTrayActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "accompany_user_tests_year2/UnloadTrayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','accompany_user_tests_year2/UnloadTrayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UnloadTrayActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = accompany_user_tests_year2.msg.UnloadTrayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = accompany_user_tests_year2.msg.UnloadTrayResult()
