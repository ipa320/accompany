...
mkdir -p camera1
cd camera1
wget -nc http://basterwijn.nl/bterwijn/Accompany/RobotHouse/camera1/2012-09-25-11-22-02.bag
...
ln -sf ./2012-09-25-11-22-02.bag video.bag
python ../../../startScripts/retopicBag.py video.bag retopic.bag /camera1
cd ../

mkdir -p camera2
cd camera2
wget -nc http://basterwijn.nl/bterwijn/Accompany/RobotHouse/camera2/2012-09-25-11-22-04.bag
...
ln -sf ./2012-09-25-11-22-04.bag video.bag
cd ../

mkdir -p camera3
cd camera3
wget -nc http://basterwijn.nl/bterwijn/Accompany/RobotHouse/camera3/2012-09-25-11-22-00.bag
...
ln -sf ./2012-09-25-11-22-00.bag video.bag
